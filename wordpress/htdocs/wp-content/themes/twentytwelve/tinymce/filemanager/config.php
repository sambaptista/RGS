<?php
	...
	$mcFileManagerConfig['filesystem.path'] = '/wp-content/uploads'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = '/wp-content/uploads'; // absolute or relative from this script path.
	...
	$mcFileManagerConfig['filesystem.extensions'] = "gif,jpg,htm,html,pdf,zip,txt,php,png,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,mp3,mp4";
	...
	// Upload options
	$mcFileManagerConfig['upload.maxsize'] = "500MB";
	...
	$mcFileManagerConfig['upload.extensions'] = "gif,jpg,png,pdf,zip,flv,mpg,avi,mp3,mp4,swf";
