...
class Shiba_Media_Permalink {
	...
	function admin_init() {
		...
		add_settings_field(	'gallery_structure', "Gallery Structure", array(&$this, 'show_gallery_structure'), 
							'permalink', 'optional',
	...
	function register_gallery_object($name = 'Gallery') {
		$labels = array(
			'name' => _x('Galeries', 'post type general name'),
		  ...
		  $args = array(
			...
			'supports' => array('title','author','thumbnail', 'comments', 'shiba-widgets', 'genesis-skins' )
		  ); 
